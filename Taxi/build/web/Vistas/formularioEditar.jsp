        ...
        <body class="fondo">
            ...
            <div class="my-5 container">
                <div class="row align-items-center">
                    ...
                    %>
                    <form action="Controlador">
                        <h1 class="text-center">Editar Reserva  <%=r.getIdReserva()%></h1>
                        <div class="form-group">
                            <input type="hidden" value="<%=r.getIdReserva()%>" class="form-control" name="idViaje">  
                        </div>
                        <div class="form-group">
                            <label for="hora">Hora</label>
                            <input required type="time" value="<%=r.getHora()%>" class="form-control" name="hora">  
                        </div>
                        <div class="form-group">
                            <label for="fecha">Fecha</label>
                            <input required type="date" value="<%=r.getFecha()%>" class="form-control" name="fecha">  
                        </div>
                        <div class="form-group">
                            <label for="origen">Origen</label>
                            <input required type="text" value="<%=r.getOrigen()%>" class="form-control" name="origen">
                        </div>
                        <div class="form-group">
                            <label for="habitacion">Habitación</label>
                            <input type="text" value="<%=r.getHabitacion()%>" class="form-control" name="habitacion">  
                        </div>
                        <div class="form-group">
                            <label for="destino">Destino</label>
                            <input required type="text" value="<%=r.getDestino()%>" class="form-control" name="destino">  
                        </div>
                        <div class="form-group">
                            <label for="pax">Pax</label>
                            <input required type="number" value="<%=r.getPax()%>" class="form-control" name="pax">
                        </div>
                        <div class="form-group">
                            <label for="observacion">Observación</label>
                            <input type="text" value="<%=r.getObservacion()%>" class="form-control" name="observacion">  
                        </div>
                        <div class="form-group">
                            <label for="claseReserva">Clase reserva</label>
                            <select name="claseReserva"  class="custom-select">
                                <option selected><%=r.getClaseReserva()%></option>
                        ...
                        <input type="submit" class="btn btn-info btn-block" value="Editar" name="accion">
                    </form>
                </div>
            </div>
        </div>
