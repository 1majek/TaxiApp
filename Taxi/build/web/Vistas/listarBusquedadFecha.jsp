    ...
    <head>
        ...
        <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark fixed-top fondo">
                ...
                <%
                    String inicio = (String) request.getAttribute("desde");
                    String fin = (String) request.getAttribute("hasta");
                    //int getNum = Integer.parseInt(num);
                    GestionDao dao = new GestionDao();
                %>
                <li class="nav-item">
                    <a class="nav-link texto bg-warning" style="color: black;" href="#" data-toggle="modal" data-target="#mimodal">Búsqueda <span title="Total" class="badge badge-danger"><%=dao.countFechaInicioFinal(inicio, fin)%></span></a>
                ...
                <div class="col">
                    ...
                    <table class="text-center my-2 table table-responsive-xs border text-center table-hover">
                        ...
                        <tr>
                            <th scope="col">
                                Total
                                <%=dao.countFechaInicioFinal(inicio, fin)%>
                            </th>
                        </tr>
