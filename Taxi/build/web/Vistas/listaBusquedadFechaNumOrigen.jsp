        ...
        <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark fixed-top fondo">
                ...
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link texto bg-warning" style="color: black;" href="#" data-toggle="modal" data-target="#mimodal">Búsqueda</a>
                    ...
                    <div class="col">
                        <table class="text-center my-2 table border table-responsive-xs text-center table-hover">
                            ...
                            <%
                                ...
                                dao.searchDateNumeroTaxiOrigen(inicio, num, origen);
