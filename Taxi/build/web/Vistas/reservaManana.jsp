            ...
            <nav class="navbar navbar-expand-lg navbar-dark fixed-top fondo">
                ...
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <div class="btn-group texto">
                        <a class="nav-link bg-warning" style="color: black;" href="Controlador?accion=reservas">Reservas <span title="Total" class="badge badge-danger"><%=dao.countManana()%></span></a>
                        <!--<button type="button" class="btn btn-warning dropdown-toggle dropdown-toggle-split" data-toggle="dropdown">
                            <span class="sr-only">Toggle Dropdown</span>
                        </button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="Controlador?accion=reservas">Reservas <span title="Total" class="badge badge-danger"><%=dao.countManana()%></span></a>
