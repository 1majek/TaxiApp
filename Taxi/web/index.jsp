...
<html>
    <head>
        <jsp:include page="./Vistas/bootStrap.html"></jsp:include>
        ...
        <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark fixed-top fondo">
                ...
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        ...
                        %>
                        <a class="nav-link bg-warning" style="color: black;" href="Controlador?accion=reservas">Reservas <span title="Total" class="badge badge-danger"><%=dao.countReserva()%></span></a>
                        <!--<button type="button" class="btn btn-warning dropdown-toggle dropdown-toggle-split" data-toggle="dropdown">
                            <span class="sr-only">Toggle Dropdown</span>
                        </button>-->
                        <!--<div class="dropdown-menu">
                            <a class="dropdown-item" href="Controlador?accion=reservasManana">Mañana <span title="Total" class="badge badge-danger"><%=dao.countManana()%></span></a>
            ...
            <form method="POST" class="form-inline" action="Controlador">
                ...
                <div class="col">
                    <table class="text-center my-2 table table-responsive-xs border text-center table-hover">
                        ...
                        <tbody>
                            ...
                            %>
                            <tr>
                                <td title="Id"><%=r.getIdReserva()%></td>
                                <td title="dias restantes"><%=r.getDiaRest()%></td>
                                <td title="Hora"><%=r.getHora()%></td>
                                <td title="Fecha"><%=r.getFecha()%></td>
                                <td title="Origen"><%=r.getOrigen()%></td>
                                <td title="Habitación"><%=r.getHabitacion()%></td>
                                <td title="Destino"><%=r.getDestino()%></td>                    
                                <td title="Pax"><%=r.getPax()%></td>
                                <td title="Observación"><%=r.getObservacion()%></td>
                                <td title="Clase Reserva"><%=r.getClaseReserva()%></td>
                                <td>
                                ...
                                <td>
                                    <span class="fw-code-copy">
                                        ...
                                        <code class="d-none"><%=r.getHora()%>   <%=r.getFecha()%>   <%=r.getOrigen()%>   <%=r.getHabitacion()%>   <%=r.getDestino()%>   <%=r.getPax()%> Pax   <%=r.getObservacion()%></code>
                                    </span>
                        ...
                        <div class="alert alert-info" role="alert">
                            Tienes <a title="Reservas hoy" href="Controlador?accion=reservasHoy" class="alert-link"><%=dao.countReservaHoy()%></a> viaje/s pendiente/s para hoy y <a title="Reservas mañana" href="Controlador?accion=reservasManana" class="alert-link"><%=dao.countManana()%></a> para mañana
                        </div>
                        </tbody>
                    </table>  
                </div>
