        ...
        <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark fixed-top fondo">
                ...
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link texto bg-warning"style="color: black;" href="Controlador?accion=listaTaxis">Viajes Por Taxista</a>
                    </li>
                    <li class="nav-item">
            ...
            <!--end nav-->
            <div class="mb-1 mt-3 invisible">
                <span>.</span>
            </div>
            <div class="container-fluid my-5">
                <div class="row">
                    <div class="col">
                        <table class="text-center my-2 table border table-responsive-xs text-center table-hover">
                            <thead class="">
                                <tr>
                            ...
                            <tbody>
                            <%
                                String numTaxista = (String) request.getAttribute("numTaxista");

                                String nombre = (String) request.getAttribute("nombre");

                                int value = Integer.parseInt(numTaxista);

                                GestionDao dao = new GestionDao();

                                dao.viajePorTaxista(value);
                        ...
                        <%}%>
                        <h4><span class="badge badge-pill badge-warning"><%=nombre%> <%=value%> <span title="Total" class="badge badge-danger"><%=dao.countTotalViaje(value)%></span></span></h4>
                        </tbody>
                    </table>
