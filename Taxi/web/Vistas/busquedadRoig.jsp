        ...
        <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark fixed-top fondo">
                ...
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link texto bg-warning"style="color: black;" href="Controlador?accion=listaTaxis">Reservas Roig</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="col">
                        <table class="text-center my-2 table table-responsive-xs border text-center table-hover">
                            ...
                            <%
                                ...
                                String roig = (String) request.getAttribute("roig");
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn" title="editar" href="Controlador?accion=editarReserva&idViaje=<%=t.getIdReserva()%>"><img style="width: 25px; height: 25px" src="./Vistas/img/edit.png"></a>
                                </td>
                                <!--Add Taxista-->
                                <td>
                                ...
                                <td>
                                    <span class="fw-code-copy">
                                        ...
                                        <code class="d-none"><%=t.getIdReserva()%>   <%=t.getTaxi()%>   <%=t.getNum_licencia()%>   <%=t.getHora()%>   <%=t.getFecha()%>   <%=t.getOrigen()%>   <%=t.getHabitacion()%>   <%=t.getDestino()%>   <%=t.getPax()%>   <%=t.getObservacion()%>   <%=t.getClaseReserva()%></code>
                                    </span>
