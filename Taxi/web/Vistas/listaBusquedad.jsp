    ...
    <head>
        ...
        <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark fixed-top fondo">
                ...
                %>
                <li class="nav-item">
                    <a class="nav-link texto bg-warning" style="color: black;" href="#" data-toggle="modal" data-target="#mimodal">Búsqueda <span title="Total" class="badge badge-danger"><%=dao.countOrigen(input)%></span></a>
                    ...
                    <table class="text-center my-2 table table-responsive-xs border text-center table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <!--<td>
                                    <a class="btn" title="eliminar" href="Controlador?accion=eliminar&idReserva=<%=t.getIdReserva()%>"onclick="if (!confirm('¿Seguro que deseas ELIMINAR la reserva de <%= t.getOrigen()%>?'))
                                                return false;"><img style="width: 25px; height: 25px" src="./Vistas/img/delete.png"></a>
                                </td>-->
                                <td>
